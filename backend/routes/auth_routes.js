...
router.get('/user/:identifier', async (req, res) => {
    try {
        ...
        // The only place where 'email' is explicitly accessed from loginRecord
        // is in the /users-detailed route.
        // Assuming the error is not here, as you already have the 404 handler.
        ...
        if (usersWithDetails.length === 0) {
            ...
            for (const detail of userDetails) {
                ...
                allUserData.push({
                    ...
                    user_detail: detail,
                    authentication: loginRecord ? {
                        email: loginRecord.email, // This is a potential point for the error if loginRecord is null
            ...
            for (const user of usersWithDetails) {
                ...
                allUserData.push({
                    ...
                    authentication: loginRecord ? {
                        email: loginRecord.email, // This is also a potential point for the error if loginRecord is null
                        is_manager: loginRecord.is_manager
                    } : null
                });
            }
